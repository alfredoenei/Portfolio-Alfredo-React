export const translations = {
    es: {
        ...
        hero: {
            ...
            steps: {
                strategy: "Estrategia y Arquitectura",
                development: "Desarrollo Frontend & Backend",
                optimization: "Optimización y Despliegue"
            }
        },
        projects: {
            title: "Proyectos Destacados",
            subtitle: "Una selección de mi trabajo más reciente, enfocado en rendimiento y experiencia de usuario.",
        ...
        contact: {
            title: "Hablemos",
            subtitle: "¿Tienes un proyecto en mente? Estoy disponible para nuevas oportunidades y colaboraciones.",
            emailLabel: "Email de contacto",
            reasonsLabel: "Razones para contactar:",
    ...
    en: {
        ...
        hero: {
            ...
            steps: {
                ...
                optimization: "Optimization & Deployment"
            }
        },
        projects: {
            title: "Featured Projects",
            subtitle: "A selection of my recent work, focused on performance and user experience.",
        ...
        contact: {
            title: "Let's Talk",
            subtitle: "Have a project in mind? I'm available for new opportunities and collaborations.",
            emailLabel: "Contact Email",
            reasonsLabel: "Reasons to connect:",
